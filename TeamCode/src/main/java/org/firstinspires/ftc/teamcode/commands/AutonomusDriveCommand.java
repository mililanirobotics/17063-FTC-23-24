...
public class AutonomusDriveCommand {
    ...
    // private TensorFlowVisionSubsystem m_tensorFlowVision;
    private AprilTagsVisionSubsystem aprilTagsVision;
    private PIDController autoPID;
    private int desiredID;
    private final ElapsedTime runtime = new ElapsedTime();

    // Tensorflow subsystem is taken out until further testing. Please readd the tensorflow subsystem parameter later
    public AutonomusDriveCommand(MecanumSubsystem mecanumSubsystem, AprilTagsVisionSubsystem aprilTagsVision) {
        m_MecanumSubsystem = mecanumSubsystem;
//        m_tensorFlowVision = tensorFlowVisionvision;
...
//    public void TeamPropMovement (double targetLength, double targetWidth, Telemetry telemetry) {
//        double[] teamPropDimensions = m_tensorFlowVision.teamPropDimensions(telemetry);
